...
That would create a scatterplot of height vs. weight.
...
ggplot(iris, aes(x = Petal.Width, y = Petal.Length, 
  ...
  labs(title="Petals of the Iris data set", 
...
- Data often must be in _long_ format, which could mean reshaping data
- The package is still evolving (ie, code that works today may not work in the future)
